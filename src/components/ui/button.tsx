  ...
  "group/button inline-flex shrink-0 items-center justify-center rounded-sm border border-transparent bg-clip-padding text-sm font-medium whitespace-nowrap transition-all outline-none select-none focus-visible:border-ring focus-visible:ring-3 focus-visible:ring-ring/50 active:not-aria-[haspopup]:translate-y-px disabled:pointer-events-none disabled:opacity-50 aria-invalid:border-destructive aria-invalid:ring-3 aria-invalid:ring-destructive/20 [&_svg]:pointer-events-none [&_svg]:shrink-0 [&_svg:not([class*='size-'])]:size-4",
  {
    variants: {
      variant: {
        ...
        /* Outlined — ghost border at 15% opacity */
        outline:
          "border-[color-mix(in_srgb,var(--on-surface)_15%,transparent)] bg-background hover:bg-surface-container-low hover:text-foreground",
        /* Ghost — tonal hover only */
        ghost:
          "hover:bg-surface-container-low hover:text-foreground",
        /* Tertiary — no bg, 2px underline that expands on hover */
        tertiary:
          "relative bg-transparent text-foreground label-md pb-0.5 after:absolute after:bottom-0 after:left-0 after:h-[2px] after:w-0 after:bg-foreground hover:after:w-full after:transition-[width] after:duration-200 after:ease-out",
        destructive:
